...
public class RegionSign {
	 ...
	 * @return Material of the sign, usually {@link Material#LEGACY_WALL_SIGN}, {@link Material#LEGACY_SIGN}, or one of the other wood types (different result for 1.13-), Material.AIR if none.
	 */
