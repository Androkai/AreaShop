...
public class WorldEditHandler7 extends WorldEditInterface {
	...
	public boolean restoreRegionBlocks(File rawFile, GeneralRegionInterface regionInterface) {
		...
		EditSession editSession = pluginInterface.getWorldEdit().getWorldEdit().newEditSessionBuilder().world(world).maxBlocks(pluginInterface.getConfig().getInt("maximumBlocks")).build();
